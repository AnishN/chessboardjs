  ...
  */
  ...
  function constructor (containerElOrString, config) {
    ...
    function buildPieceHTML (piece, hidden, id, count) {
      var html = '';
      if (hidden == false) {
	  html = '<img class="{piece}" src="' + 'img/chesspieces/numbers/blank.png' + '" '; 
      ...
      if (hidden) {
        ...
        html += 'background-image:url(/img/chesspieces/numbers/blank-' + count + '.png),url(/img/chesspieces/wikipedia/' + piece + '.png);';
